...
class SectorEndpoint extends Endpoint implements IBulkEndpoint, ILocalizedEndpoint {
    use BulkEndpoint;
     ...
     */
    public function url() {
        return 'v2/continents/' . $this->continent_id . '/floors/' . $this->floor_id . '/regions/' . $this->region_id . '/maps/' . $this->map_id . '/sectors' ;
    }
}
